...
export default function HomePage() {
  ...
  return (
    <section className="relative pt-24 px-6 text-center overflow-hidden min-h-screen flex flex-col items-center justify-center bg-black">
      {/* Fundo animado */}
      ...
      {/* Animações extras com pseudo-elementos ou gradientes podem ser adicionadas no Tailwind config */}
    </section>
  );
}
